...
```BASH
composer config repositories.nholuongut/magento-2-importing-library vcs git@github.com:ho-nl/magento2-Ho_Import.git
composer require nholuongut/magento-2-importing-library
```
